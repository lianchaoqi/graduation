...
public class FileController {
    ...
    public Result uploadToHdfs(@RequestParam MultipartFile file) throws Exception {
        String originalFilename = file.getOriginalFilename(); //TODO:文件名
        String type = FileUtil.extName(originalFilename);//TODO:获取文件扩展名（文件类型后缀名），扩展名不带“.”
        if (!"csv".equals(type)) {
            //TODO:throw new ServiceException(Constants.CODE_400, "文件类型必须是csv逗号分隔文件！");
